...
function useAutocomplete(props) {
  ...
  const windowLostFocus = React19.useRef(false);
  ...
  const highlightReasonRef = React19.useRef(null);
  const touchScrolledRef = React19.useRef(false);
  const isTouchRef = React19.useRef(false);
  ...
  const selectedValues = React19.useMemo(() => {
    if (multiple) {
      return value;
    }
    if (value != null) {
...
var Autocomplete = React31.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  const previousGroupedOptionsRef = React31.useRef([]);
  const prevPopupOpenRef = React31.useRef(false);
...
var SelectFocusSourceContext = React62.createContext(null);
if (true) {
  SelectFocusSourceContext.displayName = "SelectFocusSourceContext";
}
function useSelectFocusSource() {
  const context = React62.useContext(SelectFocusSourceContext);
  return context;
}
...
var SelectInput = React65.forwardRef(function SelectInput2(props, ref) {
  ...
  const [openInteractionType, setOpenInteractionType] = React65.useState(null);
  ...
  return (0, import_jsx_runtime49.jsxs)(React65.Fragment, {
    children: [(0, import_jsx_runtime49.jsx)(SelectSelect, {
      ...
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime49.jsx)(SelectFocusSourceProvider, {
      value: openInteractionType,
      children: (0, import_jsx_runtime49.jsx)(Menu_default, {
        id: `menu-${name || ""}`,
...
var Tab = React71.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime55.jsxs)(TabRoot, {
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime55.jsxs)(React71.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime55.jsxs)(React71.Fragment, {
      children: [label, icon]
    }), indicator]
  });
});
...
//# sourceMappingURL=chunk-5JQ4Z7LI.js.map
